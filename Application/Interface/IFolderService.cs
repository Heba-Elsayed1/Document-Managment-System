...
namespace Application.Interface
{
    public interface IFolderService
    {
        ...
        Task<GenericResult<IEnumerable<FolderDto>>> GetPublicFolders(int userId);
        Task<GenericResult<FolderDto>> GetFolderById (int id , int userId);
        Task<GenericResult<IEnumerable<FolderDto>>> GetFoldersByWorkspace (int workspaceId, int userId);
